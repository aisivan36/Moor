...
//  SQL code to create the database table
  ...
  // This opens the databse and creates it if it does not exist
  Future<Database> _initDatabase() async {
    final documentsDirectory = await getApplicationDocumentsDirectory();

    final path = join(documentsDirectory.path, _databaseName);

    // TODO Don't forget to turn Off debugging before deploying app to appstore
  ...
  Future<Database> get database async {
    ...
    // Use this to prevent concurrent access to data
    await lock.synchronized(() async {
      // Lazily instantiate the database the first time it is accessed
      if (_database == null) {
        // Call and Open the database with _initDatabase()
